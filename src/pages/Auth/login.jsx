    ...
    <>
      <div className="min-h-screen login-bg-img w-full flex items-stretch justify-center lg:gap-[30px] xl:gap-[78px] p-2 lg:px-[15px] xl:px-[100px] lg:py-[57px] bg-white dark:bg-[#201312]">
        <img
          ...
          alt="auth img"
        />
        <div className="w-full border border-[#E8EBF1] max-w-[375px] lg:max-w-[551px] rounded-[24px] p-4 lg:p-6">
          ...
          <div>
            <p className="text-[28px] xl:text-[40px] font-semibold dark:text-white">
              Biz bilan yangi kasb!
            </p>
            <p className="text-[#5D5D5D] text-lg lg:text-xl">
              Bitta bosish orqali o’z kelajagingiz uchun yangi kurs tanlang.
            </p>
          </div>
          <form className="pt-[32px]">
            ...
            <div className="flex flex-col gap-[9px] pt-[32px]">
              <label
                className="text-sm lg:text-lg font-semibold dark:text-white"
                htmlFor="parol"
              >
              ...
              <div className="text-end pt-[7px]">
                <button
                  type="button"
                  className="p-0 text-[#0979F8] font-semibold text-sm lg:text-lg hover:underline"
                >
            ...
            <div className="pt-6">
              ...
              <div className="pt-6 flex items-start justify-between lg:gap-[30px]">
                <p className="text-[#777777] text-sm lg:text-xl">
                  Hisobingiz yo’qmi?
                </p>
                <div>
                  <button
                    onClick={()=>navigate('/register')}
                    className="font-bold text-sm lg:text-xl dark:text-white"
                    type="button"
                  >
                    Ro’yxatdan o’tish
                  </button>
                  <img src={darkMode ? Mask2 : Mask1} alt="mask" />
                </div>
              </div>
            </div>
          </form>
